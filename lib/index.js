...
var argv         = require('yargs').argv,
    ...
    shrinkwrapper= require('./shrinkwrapper');
...
module.exports = function (gulp, options) {
  ...
  gulp.task('shrinkwrap', 'Shrinkwrap the existing node modules.' +
            '--existing prevents removal of existing modules. --format rewrites the same data for structure', function () {
    shrinkwrapper({ existing: !!argv.existing, format: !!argv.format });
  });
