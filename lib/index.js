...
module.exports = function (gulp, options) {
  ...
  const test = gulp.series([styleTasks.lint, unitCoverage, integrationCoverage]);
  ...
  const combinedTest = gulp.series([styleTasks.lint, testCoverage]);
  combinedTest.displayName = 'combined-test';
  combinedTest.description = 'Run all the tests with code coverage at same time';
  ...
  function runIstanbul(files, cb) {
    var done = once(cb || function () {});
    return gulp.src(options.sourceFiles, { allowEmpty: true })
  ...
  integrationCoverage.displayName = 'integration-coverage';
  integrationCoverage.description = 'Run all the integration tests with code coverage';
  function integrationCoverage(cb) {
    runWithDependencyProcess(runIstanbul, options.integrationTestFiles, cb);
  }

  unitCoverage.displayName = 'unit-coverage';
  unitCoverage.description = 'Run all the unit tests with code coverage';
